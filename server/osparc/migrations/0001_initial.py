# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-09-29 23:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recordStatus', models.IntegerField(default=1)),
                ('versionCreationTime', models.DateTimeField()),
                ('versionID', models.IntegerField(default=1)),
                ('solarAnywhereSite', models.CharField(blank=True, max_length=64, null=True)),
                ('fkAccount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='osparc.Account')),
            ],
        ),
        migrations.CreateModel(
            name='PlantType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fkAccount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='osparc.Account')),
                ('fkPlant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='osparc.Plant')),
            ],
        ),
    ]

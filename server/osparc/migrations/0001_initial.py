# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-11-01 22:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reportdefinition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='runs', to='osparc.ReportDefinition')),
            ],
        ),
        migrations.CreateModel(
            name='UploadActivity',
        ...
        migrations.AddField(
            model_name='plant',
            name='uploadactivity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='osparc.UploadActivity'),
        ),
        migrations.AddField(
            model_name='kpi',
            name='reportrun',

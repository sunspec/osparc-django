# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-25 23:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plantlatestactivationdate', models.DateField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ReportKPI',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('runsubmittime', models.DateTimeField(auto_now_add=True, null=True)),
        ...
        migrations.AddField(
            ...
            name='reportrun',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='osparc.ReportRun'),
        ),
    ]
